...
class TrainLoop:
    ...
    def run_loop(self, img, pred, features, mask):
        while (
            not self.lr_anneal_steps
            or self.step + self.resume_step < self.lr_anneal_steps
        ):

            self.run_step(img, pred, features, mask)
    ...
    def run_step(self, img, pred, features, mask):
        batch=th.cat((img, pred, features, mask), dim=1)
